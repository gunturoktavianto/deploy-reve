...
// import { Abhaya } from "@next/font/google";
            ...
            <footer className=" bg-black text-white">
                <div className="footer footer-center">
                    ...
                    <p className="md:max-w-lg text-gray-300 mt-1">
                        ...
                        accusantium quidem qui dolor tenetur aperiam?
                        Praesentium, non.
                    </p>
                    <a
                        role="button"
                        className="btn w-40 h-4 text-white bg-red-700 hover:bg-white hover:text-red-700"
                    >
                        Contact Us
                    </a>
                    <p className="font-bold text-lg text-gray-300 mt-1">
                        © 2023 ReVe
                    </p>
                </div>
                <div className="flex justify-between mt-8 border-t-2 border-slate-800 max-w-[80%] mx-auto items-center ">
