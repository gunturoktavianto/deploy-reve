        ...
        <div className="drawer drawer-end">
          ...
          <div className="drawer-side z-10 ">
            ...
            <form className="menu align-middle w-80 min-h-full bg-white py-10">
              ...
              <input type="text" placeholder="Email" className="input border border-black w-full max-w-xs bg-white text-black" />
              <label className="label">
                <span className="label-text text-black">Password</span>
              </label>
              <input type="text" placeholder="Password" className="mb-5 input border border-black w-full max-w-xs bg-white text-black" />
              <a href="" className="text-center text-blue-500 mt-5">
                Forgot Password?
              </a>
