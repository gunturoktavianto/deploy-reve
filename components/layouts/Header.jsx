                ...
                >
                    ...
                    <div className="drawer drawer-end">
                        ...
                        <div className="drawer-content">
                            ...
                            <label
                                htmlFor="my-drawer-4"
                                className="btn btn-outline btn-sm px-8 ml-8 w-30 text-white"
                            >
                                Register
                            </label>
                        </div>
                    ...
                    <div className="drawer drawer-end">
                        ...
                        <div className="drawer-content">
                            ...
                            <label
                                htmlFor="my-drawer-4"
                                className="btn btn-outline btn-sm px-8 ml-8 text-black bg-white"
                            >
                                Login
                            </label>
                        </div>
                        <div className="drawer-side z-10">
                            <label
                                ...
                                className="drawer-overlay"
                            ></label>
                            <form className="menu p-4 w-80 min-h-full">
                                {/* Sidebar content here */}
                            </form>
                        </div>
                    </div>
